...
@Component({
  selector: 'app-dhs-evolution',
  templateUrl: './dhs-evolution.component.html',
  styleUrls: ['./dhs-evolution.component.scss']
})
export class DhsEvolutionComponent implements OnInit {
