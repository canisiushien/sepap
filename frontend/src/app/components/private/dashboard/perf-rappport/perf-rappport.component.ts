...
@Component({
  selector: 'app-perf-rappport',
  templateUrl: './perf-rappport.component.html',
  styleUrls: ['./perf-rappport.component.scss']
})
export class PerfRappportComponent implements OnInit {
  ...
  extension: string[] = ["pdf", "xlsx", "docx"];
  ext!:string;
